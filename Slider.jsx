      ...
      >
        {movieList.map(item => (
                    <img
                        ...
                        className="min-w-[700px] md:h-[500px] object-cover object-left-top mr-5 rounded-md hover:border-[4px] border-gray-400 transition-all duration-100 ease-in"
                    />
                ))}
        
      </div>
      <div className='font-extrabold text-white text-center decoration-8 font-extralight'>
                <h2>watch exclusively on MovieWave</h2>
            </div>
